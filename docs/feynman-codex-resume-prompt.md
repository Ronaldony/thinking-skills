...
> 먼저 `docs/feynman-work-log/LOG-067-raw-posix-namespace-mapping-fix-20260913.md`를
...
> LOG-066의 정정을 따른다. raw POSIX 경로 host fallback 재해석 결함은 수정됐고
> 전체 373 tests/11 skipped가 통과했다. 다음은 수정 후 startup 재검증이다.
> 아래 안내는 역사 기록이다.
