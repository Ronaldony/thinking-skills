...
class RunnerJobValidateTests(unittest.TestCase):
    def setUp(self):
        ...
        mount_paths={"candidate_dir":self.paths["candidate"],"evaluator_dir":self.paths["evaluator"],"source_repo":self.paths["source"],
          "ephemeral_home":self.paths["home"],"codex_home":self.paths["codex"],"temp_dir":self.paths["tmp"],"real_home":self.paths["real"],"control_codex_home":self.paths["control"]}
        ...
        attach_native_mounts(self.job,mount_paths)
